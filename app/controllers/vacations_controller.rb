class VacationsController < ApplicationController
  ...
  private
    ...
    def vacation_params
      params.require(:vacation).permit(:company_id, :branch_id, :cost_center_id, :collaborator, :first_date, :second_date, :third_date, :first_quantity, :second_quantity, :third_quantity, :allowance, :note, :status)
    end
end
